...
import BottomPlayerSkeletonCSS from '../css/bottomPlayer-skeleton.module.css'
                        ...
                        <svg className={BottomPlayerCSS.player__btn_prev_svg} alt="prev">
                            ...
                            <div className={`${BottomPlayerCSS.player__track_play} ${BottomPlayerCSS.track_play}`}>
                                <div className={BottomPlayerCSS.track__play_contain}>
                                    <div className={`${BottomPlayerCSS.track__play_image} ${BottomPlayerSkeletonCSS.skeleton__note}`}>
                                    <svg className={BottomPlayerCSS.track__play_svg} alt="music">
                                        </svg>
                                    </div>
                                    <div className={`${BottomPlayerCSS.track__play_author} ${BottomPlayerSkeletonCSS.skeleton__title}`}>
                                        <a className={BottomPlayerCSS.track__play_author_link} href="http://"></a>
                                    </div>
                                    <div className={`${BottomPlayerCSS.track__play_album} ${BottomPlayerSkeletonCSS.skeleton__title}`}>
                                        <a className={BottomPlayerCSS.track__play_album_link}  href="http://"></a>
                                    </div>
                                </div>
